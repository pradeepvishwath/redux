...
/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@#$%^&+=!])[A-Za-z\d@#$%^&+=!]{8,}$/;
  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      try {
        if (id) {
          // const res""ponse = await updateData(formData);
          console.log("before dispatching update to saga")
        ...
        console.log("before navigatiing Sagalist")
        // navigate("/Sagalist");
        console.log("before navigatiing Sagalist")
      } catch (error) {
  ...
  return (
    <div className="p-4" id="pics">
      <div className="main-container w-75 mx-auto pt-4" id="cove">
        <div className="form-container row p-3 ">
          ...
          <div className="text-center text-primary fw-bold fs-2 mb-3">Saga Form</div>
          ...
          <div className="col-md-6 ">
            ...
            <div className="">
              <div className="input-field-wrapper">
                ...
                />
                <button
                  className="show-password-button1 fs-4 text-primary"
          ...
          <div className="col-md-6">
            ...
            <div className="">
              <div className="input-field-wrapper">
                ...
                />
                <button
                  className="show-password-buttonn1 fs-4 text-primary"
