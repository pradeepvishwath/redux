    ...
    import { getUserRequest, deleteUserRequest } from "../../../SagaFile/SagaAction";
    ...
    useEffect(() => {
        console.log("inside useeffect table component");
       getdata();
    ...
    const getdata = async () => {
        console.log("inside getdata  table component");
    ...
    const header = (
        ...
        <div className="d-md-flex">
            ...
            label="Clear"
                ...
                className=" p-button-outlined me-3 p-2"
            >
    ...
    return (
        <div className="text-center col-10 mx-auto pt-4 mt-5">
