...
const Reduxform = () => {
  ...
  return (
    <div className=" d-flex justify-content-center flex-column bgs mx-auto" id="pics">
      <div className=" d-flex justify-content-end pt-4">
        <Link to="/reduxtable">
          <button className="btn btn-grad bg-primary  text-light"> Back</button>
        </Link>
      </div>
      <div className="container col-md-8 card p-5 shadow-secondary " id="cove">
        <Form className="form">
          <div className="row">
            ...
            <div className="col-md-6 mx-auto">
              ...
              />
              <button
                className="show-password-buttonn fs-4 text-primary"
